...
float petit(float distance)
{
	...
	if (distance <= 0.750) valeur_petit = 1;
	if ((distance > 0.750) && (distance < 1.25)) valeur_petit = 2.5-(2*distance);
	if (distance >= 1.25) valeur_petit = 0;
...
float grand(float distance)
{
	...
	if (distance <= 0.750) valeur_grand = 0;
	if ((distance > 0.750) && (distance < 1.25)) valeur_grand = (2*distance)-1.5;
	if (distance >= 1.25) valeur_grand = 1;
