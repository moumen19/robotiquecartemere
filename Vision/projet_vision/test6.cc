...
//////////////////////////////////
   ...
   IplImage* srcRight;
    ...
    cvNamedWindow("rectifleft", CV_WINDOW_AUTOSIZE);
    cvNamedWindow("rectifright", CV_WINDOW_AUTOSIZE);
...
CvSize imageSize = cvGetSize(srcRight);

CvMat* leftImageR = cvCreateMat( imageSize.height, imageSize.width, CV_8U );
CvMat* rightImageR = cvCreateMat( imageSize.height, imageSize.width, CV_8U );
CvMat* vdisp = cvCreateMat( imageSize.height, imageSize.width, CV_8U );

cvSetIdentity(mx1);
printf("%f\t%f\t%f\n",CV_MAT_ELEM(*mx1,double,0,0),CV_MAT_ELEM(*mx1,double,0,1),CV_MAT_ELEM(*mx1,double,0,2));
printf("%f\t%f\t%f\n",CV_MAT_ELEM(*mx1,double,1,0),CV_MAT_ELEM(*mx1,double,1,1),CV_MAT_ELEM(*mx1,double,1,2));
printf("%f\t%f\t%f\n",CV_MAT_ELEM(*mx1,double,2,0),CV_MAT_ELEM(*mx1,double,2,1),CV_MAT_ELEM(*mx1,double,2,2));


cvRemap( leftImage, leftImageR, mx1, my1 );
cvRemap( rightImage, rightImageR, mx2, my2 );
...
//cvFindStereoCorrespondence( leftImage, rightImage, CV_DISPARITY_BIRCHFIELD, disp, 50, 15, 3, 6, 8, 15 );
	...
	cvShowImage( "rectifleft", leftImageR );
	cvShowImage( "rectifright", rightImageR );


cvFindStereoCorrespondence( 
	leftImageR, 
	rightImageR, //right image grayscale 8-bit
